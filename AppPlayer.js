...
function Appplayer() {
  const [songs] = useState([
    {
      title: "Brahmavu Shivudavu Vishnuvu Lahari",
      artist: "Sai Charan",
      album: "Geethamirutham",
      track: "Brahmavu Shivudavu Vishnuvu Lahari",
      year: "2022",
      img_src: "./Song_Images/Geethamrutham.jpg",
      src: "/Audios/21 Brahmavu Shivudavu Vishnuvu.mp3",
    },
    {
      title: "Krishna Manamohana",
      artist: "Cores",
      album: "Krishna Ganam",
      track: "Krishna Manamohana",
      year: "2015",
      img_src: "./Song_Images/krishna.jpg",
      src: "/Audios/Krishna Manamohana From Mahabharath Serial Tamil ( 256kbps cbr ).mp3",

    },
    {
      title: "Senthoor Sellum",
      artist: "TMS",
      album: "Murugan",
      track: "3",
      year: "2010",
      img_src: "./Song_Images/murugan.jpg",
      src: "/Audios/Senthoor Sellum ( 256kbps cbr ).mp3",
    },
    {
      title: "88 Keys",
      artist: "Oatmello",
